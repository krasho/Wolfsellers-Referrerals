...
class Update extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('Referral has been updated successfully.'));
        } catch (\Exception $e) {
            $this->messageManager->addErrorMessage(__('Error occurred while update referral.' .$e->getMessage()));
        }
